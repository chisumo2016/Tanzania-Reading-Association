...
<nav id="sidebar-wrapper">
    <ul class="sidebar-nav">
        ...
        <li class="sidebar-brand">
            <a class="js-scroll-trigger" href="#top">Tanzania Association</a>
        </li>
        <li>
        ...
        <li>
            <a class="js-scroll-trigger" href="#news">News</a>
        </li>
        ...
        <li>
            <a class="js-scroll-trigger" href="#membership">Membership</a>
        </li>
